...
type MeldExpendituresListUnitDisplayAddress struct {
...
type MeldExpendituresListUnit struct {
	...
	DisplayAddress        MeldExpendituresListUnitDisplayAddress `json:"display_address"`
