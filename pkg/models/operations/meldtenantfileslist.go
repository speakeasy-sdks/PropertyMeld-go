...
type MeldTenantFilesListResponse struct {
	ContentType                  string
	PaginatedPmAPITenantMeldList *shared.PaginatedPmAPITenantMeldList
	StatusCode                   int
