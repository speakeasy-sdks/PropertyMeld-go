...
type WorkLogRetrieveResponse struct {
	ContentType               string
	StatusCode                int
	RawResponse               *http.Response
	WorkEntrySerializerDetail *shared.WorkEntrySerializerDetail
}
