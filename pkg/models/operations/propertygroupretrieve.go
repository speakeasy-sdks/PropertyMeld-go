...
type PropertyGroupRetrieveResponse struct {
	ContentType                   string
	PropertyGroupSerializerDetail *shared.PropertyGroupSerializerDetail
	StatusCode                    int
