...
type VendorFileListResponse struct {
	ContentType                 string
	PaginatedVendorMeldFileList *shared.PaginatedVendorMeldFileList
	StatusCode                  int
