...
type PropertyGroupListResponse struct {
	ContentType                              string
	PaginatedPropertyGroupSerializerListList *shared.PaginatedPropertyGroupSerializerListList
	StatusCode                               int
